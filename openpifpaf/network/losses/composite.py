...
class CompositeLoss(torch.nn.Module):
    ...
    def __init__(self, head_net: heads.CompositeField3):
        ...
        LOG.info('%s: n_vectors = %d, n_scales = %d',
    ...
    def _confidence_loss(self, x_confidence, t_confidence):
        ...
        # LOG.info('batch size = %d, n fields = %d, n_features = %d',
        ...
        # LOG.info('BCE: x = %s, target = %s, mask = %s',
        ...
        if self.bce_total_soft_clamp is not None:
            ...
            LOG.info('summed ce loss = %s, soft clamp = %f', ce_loss, total_clamp_value)
    ...
    def forward(self, x, t):
        # LOG.info('loss for %s', self.field_names)
